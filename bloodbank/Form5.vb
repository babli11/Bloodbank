...
Public Class frmscdelete
    ...
    Private Sub frmscdelete_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub Button2_Click(sender As System.Object, e As System.EventArgs) Handles Button2.Click
        ...
        cmd.Connection = con
        con.Open()
        cmd.CommandText = "select * from sreening"
